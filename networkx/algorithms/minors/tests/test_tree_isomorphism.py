    ...
    for _ in range(num_trials):
        ...
        for node_affinity in affinity_funcs:
            ...
            for impl in impls:
                ...
                subtree1, subtree2, _ = maximum_common_ordered_subtree_isomorphism(
...
def check_btree_case():
    ...
    subtree1, subtree2, _ = maximum_common_ordered_subtree_isomorphism(
        tree1, tree2, node_affinity=node_affinity, item_type=item_type
    )
    nx.set_node_attributes(
...
def check_dfs_relabel_case():
    ...
    subtree1, subtree2, _ = maximum_common_ordered_subtree_isomorphism(tree1, tree2)
    print("subtree1")
    print(nx.forest_str(subtree1))
    print("subtree2")
    print(nx.forest_str(subtree2))
...
def _check_subtree_isomorphism_invariants(
    ...
    alt_subtree1, alt_subtree2, _ = maximum_common_ordered_subtree_isomorphism(
    ...
    alt_subtree1, _, _ = maximum_common_ordered_subtree_isomorphism(
        subtree1, tree2, node_affinity=node_affinity
    )
    _, alt_subtree2, _ = maximum_common_ordered_subtree_isomorphism(
        tree1, subtree2, node_affinity=node_affinity
    )
    assert set(alt_subtree1.edges) == set(subtree1.edges)
    assert set(alt_subtree2.edges) == set(subtree2.edges)

    alt_embed1, _ = maximum_common_ordered_tree_embedding(
        subtree1, tree2, node_affinity=node_affinity
    )
    _, alt_embed2 = maximum_common_ordered_tree_embedding(
        tree1, subtree2, node_affinity=node_affinity
    )
...
def test_custom_large_case():
    ...
    subtree1, subtree2, weight = maximum_common_ordered_subtree_isomorphism(
        tree1, tree2
    )
