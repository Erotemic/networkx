...
static const char __pyx_k_head_tail[] = "head_tail";
...
static const char __pyx_k_all_decomp[] = "all_decomp";
...
static const char __pyx_k_open_to_tok[] = "open_to_tok";
...
static const char __pyx_k_cythonize_a_i_code_networkx_net[] = "\ncythonize -a -i ~/code/networkx/networkx/algorithms/isomorphism/_embeddinghelpers/balanced_sequence_cython.pyx\n\nExamples\n--------\n>>> from networkx.algorithms.isomorphism.balanced_sequence import *  # NOQA\n>>> from networkx.algorithms.isomorphism.balanced_sequence import _lcs_iter_simple, _lcs_iter_simple_alt1, _lcs_iter_simple_alt2, _lcs_iter_prehash, _lcs_recurse, _print_forest\n>>> tree1 = random_ordered_tree(5, seed=10, pool='[{(')\n>>> tree2 = random_ordered_tree(5, seed=3, pool='[{(')\n\n>>> import kwarray\n>>> rng = kwarray.ensure_rng(3432432, 'python')\n>>> tree1 = random_ordered_tree(300, seed=rng, pool='[{(')\n>>> tree2 = random_ordered_tree(300, seed=rng, pool='[{(')\n>>> if len(tree1.nodes) < 20:\n>>>     _print_forest(tree1)\n>>>     _print_forest(tree2)\n>>> seq1, open_to_close, toks = tree_to_seq(tree1, mode='label', strhack=1)\n>>> seq2, open_to_close, toks = tree_to_seq(tree2, open_to_close, toks, mode='label', strhack=1)\n>>> full_seq1 = seq1\n>>> full_seq2 = seq2\n\n>>> node_affinity = operator.eq\n>>> open_to_tok = ub.invert_dict(toks)\n>>> from networkx.algorithms.isomorphism.balanced_sequence_cython import _lcs_iter_simple_alt2_cython  # NOQA\n\nwith ub.Timer('cython'):\n    best, value = _lcs_iter_simple_alt2_cython(full_seq1, full_seq2, open_to_close, node_affinity, open_to_tok)\n\nwith ub.Timer('python'):\n    best, value = _lcs_iter_simple_alt2(full_seq1, full_seq2, open_to_close, node_affinity, open_to_tok)\n\nReferences\n----------\nhttps://stackoverflow.com/questions/41909486/returning-a-complex-object-containing-pyobject-from-c-function-cython\n";
        ...
        static PyObject *__pyx_n_s_all_decomp;
        ...
        static PyObject *__pyx_n_s_generate_all_decomp_cython;
        static PyObject *__pyx_kp_u_generate_all_decomp_cython_line;
        ...
        static PyObject *__pyx_n_s_head_tail;
        ...
        static PyObject *__pyx_n_s_open_to_tok;
        ...
        static PyObject *__pyx_kp_u_tree_random_ordered_tree_10_seq;
...
static PyObject *__pyx_pw_8networkx_10algorithms_11isomorphism_17_embeddinghelpers_24balanced_sequence_cython_1_lcs_iter_simple_alt2_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_full_seq1,&__pyx_n_s_full_seq2,&__pyx_n_s_open_to_close,&__pyx_n_s_node_affinity,&__pyx_n_s_open_to_tok,0};
 ...
 */
  __pyx_t_1 = (__pyx_v_open_to_tok == Py_None);
 ...
 */
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_7, 0+__pyx_t_6, __pyx_v_full_seq1);
    __Pyx_INCREF(__pyx_v_open_to_close);
    __Pyx_GIVEREF(__pyx_v_open_to_close);
    PyTuple_SET_ITEM(__pyx_t_7, 1+__pyx_t_6, __pyx_v_open_to_close);
    __Pyx_INCREF(__pyx_v_open_to_tok);
 ...
 */
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 0+__pyx_t_6, __pyx_v_full_seq2);
    __Pyx_INCREF(__pyx_v_open_to_close);
    __Pyx_GIVEREF(__pyx_v_open_to_close);
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_6, __pyx_v_open_to_close);
    __Pyx_INCREF(__pyx_v_open_to_tok);
    __Pyx_GIVEREF(__pyx_v_open_to_tok);
 ...
 */
      ...
      #endif
      {
        ...
        PyTuple_SET_ITEM(__pyx_t_7, 0+__pyx_t_6, __pyx_v_t1);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_open_to_tok);
...
static PyObject *__pyx_pw_8networkx_10algorithms_11isomorphism_17_embeddinghelpers_24balanced_sequence_cython_5generate_all_decomp_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate_all_decomp_cython (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_seq,&__pyx_n_s_open_to_close,&__pyx_n_s_open_to_tok,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  2:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_open_to_tok);
 ...
 */
      ...
      PyTuple_SET_ITEM(__pyx_t_9, 0, __pyx_v_tok);
      __Pyx_INCREF(__pyx_v_pop_open);
      __Pyx_GIVEREF(__pyx_v_pop_open);
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_tok);
  __Pyx_GIVEREF(__pyx_v_tok);
  PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_v_tok);
  __Pyx_INCREF(__pyx_v_seq);
  __Pyx_GIVEREF(__pyx_v_seq);
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __pyx_k_cythonize_a_i_code_networkx_net, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Used_when_open_to_tok_is_unspec, __pyx_k_Used_when_open_to_tok_is_unspec, sizeof(__pyx_k_Used_when_open_to_tok_is_unspec), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_all_decomp, __pyx_k_all_decomp, sizeof(__pyx_k_all_decomp), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_generate_all_decomp_cython, __pyx_k_generate_all_decomp_cython, sizeof(__pyx_k_generate_all_decomp_cython), 0, 0, 1, 1},
  {&__pyx_kp_u_generate_all_decomp_cython_line, __pyx_k_generate_all_decomp_cython_line, sizeof(__pyx_k_generate_all_decomp_cython_line), 0, 1, 0, 0},
  ...
  {&__pyx_n_s_head_tail, __pyx_k_head_tail, sizeof(__pyx_k_head_tail), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_open_to_tok, __pyx_k_open_to_tok, sizeof(__pyx_k_open_to_tok), 0, 0, 1, 1},
  ...
  {&__pyx_kp_u_tree_random_ordered_tree_10_seq, __pyx_k_tree_random_ordered_tree_10_seq, sizeof(__pyx_k_tree_random_ordered_tree_10_seq), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("balanced_sequence_cython", __pyx_methods, __pyx_k_cythonize_a_i_code_networkx_net, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_generate_all_decomp_cython_line, __pyx_kp_u_tree_random_ordered_tree_10_seq) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
