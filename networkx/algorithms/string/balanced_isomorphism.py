...
def longest_common_balanced_isomorphism(
    ...
    * A simlar function that relaxes isomorphisms to embeddings is :func:`networkx.algorithms.strength.balanced_sequence.longest_common_balanced_sequence`
    ...
    if impl == "iter":
        ...
        val_any, best_any, val_lvl, best_lvl = balanced_isomorphism_cython._lcsi_iter_cython(
...
def _autojit_this():
    from networkx.algorithms.string.balanced_sequence import _autojit_cython
    import networkx as nx
    from os.path import dirname, join

    pyx_suffix = "algorithms/string/balanced_isomorphism_cython.pyx"
...
def _cython_lcsi_backend(error="ignore"):
    """
    ...
    try:
        from networkx.algorithms.string import balanced_isomorphism_cython
    except Exception:
        if error == "ignore":
            return None
        elif error == "raise":
